...
'''
监控linux服务，并返回运行状态，发送短信，优化下面
（1）没有判断tomcat僵死
（2）响应超过多少秒时，也需要发送预警短信
（3）ssh登陆只通过密码，秘钥的形式不支持
（4）同一服务有多个进程的情况下，比如nginx、tomcat有多个进程
（5）nginx服务同时存在多个服务器中
'''
...
def server_connect(): 
    ...
    for i in range(len(server)):
        ...
        #公钥秘钥登陆ssh.connect(hostname='123.56.85.22', port=22, username='jinzj', key=private_key)
...
if __name__ == '__main__': 
    l0= ['mysql','192.168.0.82','22','root','stcy@2014']
    l1= ['nagios','192.168.0.82','22','root','stcy@2014']
    l2= ['rdisc','123.56.85.22','22','jinzj','Yy@19811008']
    l3= ['tomcat','192.168.0.82','22','root','stcy@2014']
    server = [l0,l1,l2,l3]
    
    mobile_list = ['15200000000','15800000000']
